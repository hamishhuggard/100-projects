...
loader.load('arrow.png', function(texture) {
    ...
    const xAxisArrow = new THREE.Mesh(planeGeometry, planeMaterial);
    ...
    const xAxisArrow2 = new THREE.Mesh(planeGeometry, planeMaterial);
    xAxisArrow2.position.set(0, 0, 0); // Position it at the end of the x-axis
    xAxisArrow2.rotation.z = -Math.PI / 2; // Rotate to align with the x-axis
    xAxisArrow2.rotation.x = -Math.PI / 2; // Rotate to align with the x-axis
    scene.add(xAxisArrow2);

    // Create and position the plane for the y-axis
    const yAxisArrow = new THREE.Mesh(planeGeometry, planeMaterial);
    yAxisArrow.position.set(0, 0, 0); // Position it at the end of the y-axis
    scene.add(yAxisArrow);

    const yAxisArrow2 = new THREE.Mesh(planeGeometry, planeMaterial);
    yAxisArrow2.position.set(0, 0, 0); // Position it at the end of the y-axis
    yAxisArrow2.rotation.y = -Math.PI / 2; // Rotate to align with the x-axis
    scene.add(yAxisArrow2);

    // Create and position the plane for the x-axis
    const zAxisArrow = new THREE.Mesh(planeGeometry, planeMaterial);
    ...
    const zAxisArrow2 = new THREE.Mesh(planeGeometry, planeMaterial);
    zAxisArrow2.position.set(0, 0, 0); // Position it at the end of the x-axis
    zAxisArrow2.rotation.x = -Math.PI / 2; // Rotate to align with the x-axis
    zAxisArrow2.rotation.y = -Math.PI / 2; // Rotate to align with the x-axis
    scene.add(zAxisArrow2);
});
