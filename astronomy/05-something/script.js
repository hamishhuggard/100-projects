...
function drawArea() {
    ...
    const polygon = document.querySelector('#swept-area') || document.createElementNS(svgNS, "polygon");
    ...
    polygon.setAttribute("id", "swept-area"); // Ensure we keep updating the same polygon

    // Append the polygon to the connector (SVG container)
    const connector = document.querySelector('.connector');
    if (!document.querySelector('#swept-area')) {
